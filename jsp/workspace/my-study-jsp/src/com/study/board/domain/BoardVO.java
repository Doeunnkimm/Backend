...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [boardContent=" + boardContent + ", boardId=" + boardId + ", boardReadCount=" + boardReadCount
				+ ", boardRegisterDate=" + boardRegisterDate + ", boardTitle=" + boardTitle + ", boardUpdateDate="
				+ boardUpdateDate + ", memberId=" + memberId + "]";
	}
