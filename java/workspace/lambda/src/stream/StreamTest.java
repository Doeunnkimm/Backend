...
//		ArrayList<String> strData = new ArrayList<String>(Arrays.asList("가", "나", "다"));
//		strData.stream().map(data -> data+"OK").forEach(System.out::println);
//		
...
//		 System.out.println(datas); // 원본을 건드리지 않음
