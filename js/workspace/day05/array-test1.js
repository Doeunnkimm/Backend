/* * 값에 || 연산자를 사용하면 fasle 값일 경우 뒤에 있는 값으로 대체된다. */
// let data = '';
// let result = data || 1; // data가 fasle이면 1을 넣어라
// console.log(result);
...
// // join() : 원하는 구분점으로 문자열로 전달하여 각 요소를 구분한 뒤 문자열로 리턴
